...
import com.hritik.foodhunt.activity.DetailActivity
import com.hritik.foodhunt.database.FavouriteDatabase
import com.hritik.foodhunt.database.FavouriteEntity
...
class HomeAdapter(val context: Context, private val itemList: ArrayList<Restaurants>) :
    ...
    override fun onBindViewHolder(holder: HomeViewHolder, position: Int) {
        ...
        Picasso.get().load(res.img_url).error(R.drawable.default_img).into(holder.imgRes)
